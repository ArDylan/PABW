<header
            ...
            style="background: linear-gradient(rgba(0,0,0,0.35), rgba(0,0,0,0.35)), url('asset/img/plane.jpg') center; background-size: cover; background-repeat: no-repeat;">
            ...
            <main
                ...
                <div class="flex flex-row gap-3 items-center justify-start self-stretch shrink-0 relative">
                    <div class="flex flex-row gap-3 items-center justify-start shrink-0 relative">
                        ...
                        <div
                            class="text-white text-left font-['Inter-Medium',_sans-serif] text-sm font-medium relative">
                            Find Flights </div>
                    </div>
                ...
                <div
                    class="flex flex-row gap-2 items-center justify-center md:justify-end self-stretch shrink-0 relative">
